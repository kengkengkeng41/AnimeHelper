...
public class Constants {
    ...
    public final static String LOCAL_DIC_AVATAR_1 = "src/main/resources/static/avatar/";
    public final static String LOCAL_DIC_AVATAR_2 = "target/classes/static/avatar/";
    public final static String LOCAL_DIC_PICTURE_1 = "src/main/resources/static/picture/";
    public final static String LOCAL_DIC_PICTURE_2 = "target/classes/static/picture/";
    public final static String AVATAR_UPLOAD_DIC = "http://localhost:8081/avatar/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String PICTURE_UPLOAD_DIC = "http://localhost:8081/picture/";//上传文件的默认url前缀，根据部署设置自行修改
//    public final static String FILE_UPLOAD_DIC = "D:\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static String MALL_USER_SESSION_KEY = "visitor";//session中user的key
    ...
    public final static String USER_INTRO = "爽籁发而清风生，纤歌凝而白云遏";//默认简介
}
